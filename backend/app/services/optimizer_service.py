...
def optimizer_config(settings: schemas.AlgorithmSettings) -> OptimizerConfig:
    ...
    return OptimizerConfig(
        ...
        operational_normalizer=settings.operationalNormalizer,
        ...
        max_expensive_axis_src_delta=settings.maxExpensiveAxisSrcDelta,
        max_expensive_axis_move_delta=settings.maxExpensiveAxisMoveDelta,
